<template>
	<div class="sidebar">
		<el-menu :default-active="onRoutes" class="el-menu-vertical-demo" background-color="#324157" text-color="#bfcbd9" active-text-color="#fff" unique-opened router>
			...
			<el-submenu index="2" popper-class="Components">
				<template slot="title">
