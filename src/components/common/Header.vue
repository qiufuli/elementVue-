	...
	<div class="header">
		<el-row :gutter="10">
			<el-col :xs="12" :sm="12" :md="4">
				<div class="logo">
					<span class="logo_prefix">qiufuli</span>
			...
			<el-col :xs="12" :sm="12" :md="8">
				<div class="search">
					<el-input size="small" placeholder="Search for...">
						<el-button size="medium" slot="append" icon="el-icon-search"></el-button>
					</el-input>
				</div>
			</el-col>
			<!--header right area-->
				...
				<div class="header-right">
								...
								<el-dropdown-item v-for="dialog in dialogs" :key="dialog.time" divided>
									<div class="pop-div">
										<span class="pop-image">
											<img :src="dialog.header" width="50" alt="" />
										</span>
					...
					<el-col :span="8">
						<el-dropdown placement="top-start">
							...
							<el-dropdown-menu slot="dropdown">
								<el-dropdown-item>
									<span class="pop-title"> You have new task!</span>
								</el-dropdown-item>
			...
			<el-col :xs="8" :sm="8" :md="2">
				<div class="user-header">
					<el-dropdown trigger="click" placement="top">
						<img src="../../../static/images/b_header.jpg" width="50" alt="" />
						<el-dropdown-menu slot="dropdown">
							<el-dropdown-item >
